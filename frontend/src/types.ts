...
export interface ReleaseUpdate { title: string; artist: string; release_date: string; release_type: string; source_url: string }
export interface ReleaseRadarResult { provider: string; status: 'ready' | 'partial' | 'empty' | 'error'; message: string; new_releases: ReleaseUpdate[]; upcoming_albums: ReleaseUpdate[]; artist_updates: ReleaseUpdate[] }
