...
- Apple 返回 `import_rows`：source_platform、playlist_id、playlist_name、track_title、artist、duration_ms、source_url、availability、import_status。缺失信息保留 null / 空艺人数组，不生成 0 时长、虚假艺人或替代歌曲。缺元数据/缺艺人/非 songs 行明确跳过。
